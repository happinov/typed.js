	  ...
	  _createClass(Typed, [{
	    ...
	    value: function typewrite(curString, curStrPos) {
	      ...
	      this.timeout = setTimeout(function () {
	        ...
	        var initialCurStrPos = curStrPos;
	        // Parse html after checking for pause value
	        ...
	        _this2.timeout = setTimeout(function () {
	          ...
	          if (dispatchEvent === true && curString.charAt(curStrPos) !== '') {
	            var _event = new CustomEvent('typed', { detail: { char: curString.charAt(curStrPos) } });
	            // Dispatch a custom event with printed char in detail property
	            _this2.el.dispatchEvent(_event);
	          }
	        }, pauseTime);
